package pl.sztukakodu.bookmmr.catalog.infrastructure;

import org.springframework.stereotype.Repository;
import pl.sztukakodu.bookmmr.catalog.domain.Book;
import pl.sztukakodu.bookmmr.catalog.domain.CatalogRepository;
...
class MemoryCatalogRepository implements CatalogRepository {
    ...
    public MemoryCatalogRepository() {
        ...
        storage.put(4L, new Book(4L, "Pan Wołodyjowski", "Henryk Sienkiewicz", 1907));
    }
